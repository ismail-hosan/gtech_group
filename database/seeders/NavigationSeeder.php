            ...
            (object) array(
                ...
                'submenu' => (object) array(
                    (object) array(
                        ...
                        'parent_id' => null,
                        'childMenu' => (object) array(
                            (object) array('label' => 'All Project', 'route' => 'project.index', 'icon' => 'fa fa-dashboard', 'navigate_status' => 1),
                            (object) array('label' => 'Add New Project', 'route' => 'project.create', 'icon' => 'fa fa-dashboard', 'navigate_status' => null),
                            (object) array('label' => 'Edit Project', 'route' => 'project.edit', 'icon' => 'fa fa-dashboard', 'navigate_status' => null),
                            (object) array('label' => 'Show Project', 'route' => 'project.show', 'icon' => 'fa fa-dashboard', 'navigate_status' => null),
                            (object) array('label' => 'Destroy Project', 'route' => 'project.destroy', 'icon' => 'fa fa-dashboard', 'navigate_status' => null),
                        )
                    ),
