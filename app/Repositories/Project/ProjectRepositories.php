        ...
        if ($project) {
            foreach ($project as $key => $eproject) {
                ...
                if ($ced != 0) :
                    ...
                    if ($delete != 0) {
                        $delete_data = '<a delete_route="' . route('project.destroy', $eproject->id) . '" delete_id="' . $eproject->id . '" title="Delete" class="btn btn-xs btn-default delete_row uniqueid' . $eproject->id . '"><i class="fa fa-times"></i></a>';
                    } else {
                        $delete_data = '';
                    }
