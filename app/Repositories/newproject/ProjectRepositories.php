     ...
     public function getList($request)
     {
         ...
         if ($OurClient) {
             ...
             foreach ($OurClient as $key => $eOurClient) {
                 ...
                 $nestedData['created'] = $eOurClient->created_by;
                 ...
                 if ($ced != 0) :
                     ...
                     if ($delete != 0) {
                         $delete_data = '<a delete_route="' . route('project.destroy', $eOurClient->id) . '" delete_id="' . $eOurClient->id . '" title="Delete" class="btn btn-xs btn-default delete_row uniqueid' . $eOurClient->id . '"><i class="fa fa-times"></i></a>';
                     } else {
                         $delete_data = '';
                     }
